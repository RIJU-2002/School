...
const Drawer = ({ children, isOpen, setIsOpen }: DrawerProps) => {
    ...
    return (
        ...
        >
            <section
                className={
                    "w-340px max-w-lg left-1/2 right-1/2 absolute bg-white h-full -translate-x-1/2 -translate-y-1/2 shadow-xl delay-400 duration-500 ease-in-out transition-all transform " +
